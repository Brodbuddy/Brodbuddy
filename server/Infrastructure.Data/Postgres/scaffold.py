...
table_params = " ".join([f"--table {table}" for table in table_list]) # Her laver vi så en liste af tabeller vi vil scaffolde, hvilket så bliver alle tabeller undtagen dem vi har ekskluderet
