...
public class RefreshTokenRepositoryTests
{
    ...
    public RefreshTokenRepositoryTests()
    {
        ...
        _repository = new RefreshTokenRepository(_dbContext, _timeProvider);
    }
    
    
    public class CreateAsync : RefreshTokenRepositoryTests
    {
       [Fact]
    ...
    public class TryValidateAsync : RefreshTokenRepositoryTests
    {
        [Fact]
    ...
    public class RevokeAsync : RefreshTokenRepositoryTests
    {
         [Fact]
    ...
    public class RotateAsync : RefreshTokenRepositoryTests
    {
        [Fact]
