  ...
  return (
    <input
      ...
      className={cn(
        ...
        type === "file" && "file:mr-4 file:rounded-md file:bg-accent-foreground file:px-4 file:py-1 file:text-primary-foreground file:font-semibold hover:file:bg-accent-foreground/90 file:cursor-pointer",
        className
      )}
      {...props}
    />
